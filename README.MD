...
- [ ] might not be recording accuracy at 100% completion of the round PLEASE FIX
- [ ] remove the 0/0 on the graph
- [ ] track the min and maximum % accuracy and make the y ticks go between them
