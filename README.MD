...
- [ ] implement a feature where the program ignores lines starting with a #. this allows me to put metadata in the flash card file and print it out when the session starts.
