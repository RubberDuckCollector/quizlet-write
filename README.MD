...
how are you?|¿qué tal?
```
for the whole length of the file, save for lines starting with a `#`. They'll be ignored by the program as code comments.

# Optional

- matplotlib (will be made optional through an extra command line argument in the future)
